...
public class UserController {
    ...
    public R smsLogin(@Valid @RequestBody smsLoginForm form){
        HashMap map=userService.smsLogin(form.getPhone(),form.getCode());
        boolean result=(boolean) map.get("result");
        if(result){
            int userId=(int)map.get("userId");
            StpUtil.setLoginId(userId);
    ...
    public R getPhoneCode(@Valid @RequestBody GetPhoneCode form){
        HashMap map=userService.getPhoneCode(form.getPhone(),form.getCode());
        boolean result=(boolean) map.get("result");
        if(result){
            int userId=(int)map.get("userId");
            StpUtil.setLoginId(userId);
